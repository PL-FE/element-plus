...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/jp/message-box.md?vue&type=template&id=22136700

var message_boxvue_type_template_id_22136700_hoisted_1 = {
...
var _hoisted_21 = /*#__PURE__*/Object(vue_esm_browser["m" /* createStaticVNode */])("<div class=\"tip\"><p>MessageBoxの内容は <code>VNode</code> にすることができ、カスタムコンポーネントを渡すことができます。MessageBoxを開くとき、Vueは新しい <code>VNode</code> と古い <code>VNode</code> を比較し、UIを効率的に更新する方法を考え出します。この場合、MessageBoxが開くたびに <code>VNode</code> に一意のキーを追加することができます。<a href=\"https://jsfiddle.net/zhiyang/ezmhq2ef\">例</a>。</p></div><h3 id=\"htmlwen-zi-lie-woshi-yong-suru\"><a class=\"header-anchor\" href=\"#htmlwen-zi-lie-woshi-yong-suru\">¶</a> HTML文字列を使用する</h3><p><code>message</code> は HTML 文字列をサポートしています。</p>", 3);
...
var _hoisted_26 = /*#__PURE__*/Object(vue_esm_browser["m" /* createStaticVNode */])("<div class=\"warning\"><p><code>message</code>プロパティはHTML文字列をサポートしていますが、任意のHTMLを動的にレンダリングすると<a href=\"https://en.wikipedia.org/wiki/Cross-site_scripting\">XSS攻撃</a>につながりやすく、非常に危険です。したがって、<code>dangerouslyUseHTMLString</code>がオンの場合は、<code>message</code>の内容が信頼できるものであることを確認し、<strong>決して</strong>ユーザが提供したコンテンツに<code>message</code>を代入しないようにしてください。</p></div><h3 id=\"kiyanserutokurozuwoqu-bie-suru\"><a class=\"header-anchor\" href=\"#kiyanserutokurozuwoqu-bie-suru\">¶</a> キャンセルとクローズを区別する</h3><p>場合によっては、キャンセルボタンをクリックするのと閉じるボタンをクリックするのでは意味が異なる場合があります。</p>", 3);
...
function message_boxvue_type_template_id_22136700_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["G" /* openBlock */])(), Object(vue_esm_browser["j" /* createBlock */])("section", message_boxvue_type_template_id_22136700_hoisted_1, [_hoisted_2, Object(vue_esm_browser["o" /* createVNode */])(_component_demo_block, null, {
...
// CONCATENATED MODULE: ./website/docs/jp/message-box.md?vue&type=template&id=22136700
...
message_boxvue_type_script_lang_ts.render = message_boxvue_type_template_id_22136700_render
